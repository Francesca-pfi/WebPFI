    ...
    public function display(){
        ...
        if (isset($_SESSION["userID"])) {
            if ($TDG->is_image_liked_by($this->id, $_SESSION["userID"])) {
                $btnLike = "<a href='./DOMAINLOGIC/unlikeImage.dom.php?imageID=" . $this->id . "' class='btn btn-danger'>Unlike</a>";
            }
            else {
                $btnLike = "<a href='./DOMAINLOGIC/likeImage.dom.php?imageID=" . $this->id . "' class='btn btn-primary'>Like</a>";;
            }
        }
        echo "<div class='card text-white bg-dark w-95'" . $style . " >";
